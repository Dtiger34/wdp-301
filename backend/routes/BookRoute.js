...
router.get('/borrow-requests/pending', jwtConfig.requireAdminOrStaff, BookController.getPendingBorrowRequests);
...
router.get("/reviews", jwtConfig.requireAdminOrStaff, BookController.getAllReviews);
