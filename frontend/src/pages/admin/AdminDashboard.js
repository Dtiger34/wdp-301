            ...
            <div style={{ display: 'flex', flex: 1 }}>
                ...
                <aside style={{
                    ...
                    <ul style={{ listStyle: 'none', padding: 0 }}>
                        ...
                        <li style={{ marginBottom: '15px' }}>
                            <Link to="/admin/categories" style={linkStyle}>🏷️ Quản lý thể loại</Link>
                        </li>
                        <li style={{ marginBottom: '15px' }}>
                            <Link to="/admin/bookshelves" style={linkStyle}>🗄️ Quản lý kệ sách</Link>
                        </li>
                        <li style={{ marginBottom: '15px' }}>
                ...
                <main style={{ flex: 1, padding: '40px', backgroundColor: '#ecf0f1' }}>
                    {children ? children : (
                        <>
                            <h2 style={{ marginBottom: '50px' }}>👋 Chào mừng Admin</h2>
